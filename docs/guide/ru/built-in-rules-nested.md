...
Visual representation of it might look like this (also available at [JSFiddle](http://jsfiddle.net/fys8uadr/)):
...
- Для более детальной информации смотрите[Configuring rules via PHP attributes] секцию.
